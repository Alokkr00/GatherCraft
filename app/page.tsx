      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-900/60 via-slate-900/80 to-purple-900/40 p-8 sm:p-10 border border-indigo-500/20 shadow-2xl space-y-8">
        ...
        <div className="relative z-10 max-w-3xl space-y-5">
          ...
          <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-white leading-tight">
            Bring people together. <br className="hidden sm:inline" />
            <span className="gradient-text">On purpose.</span>
          </h1>

          <p className="text-base sm:text-lg text-slate-300 font-light leading-relaxed">
            Stop planning parties with spreadsheets and generic notes. GatherCraft helps you design, host, and reflect on meaningful gatherings—without carrying the whole event in your head.
          </p>

          {/* Interactive Purpose Prompt Box */}
          <form 
            onSubmit={(e) => {
              e.preventDefault();
              if (quickPurpose.trim()) {
                router.push(`/events/create?purpose=${encodeURIComponent(quickPurpose.trim())}`);
              } else {
            ...
            className="pt-2"
          >
            <div className="p-2 rounded-2xl bg-slate-950/80 border border-indigo-500/30 shadow-2xl backdrop-blur-md flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-bold text-white bg-gradient-to-r from-indigo-600 via-indigo-500 to-violet-600 hover:from-indigo-500 hover:to-violet-500 shadow-lg shadow-indigo-500/25 transition-all whitespace-nowrap"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-6 border-t border-slate-800/80">
          ...
          <div className="bg-slate-900/60 p-4 rounded-2xl border border-slate-800 space-y-1.5">
            ...
            <p className="text-xs text-slate-300">
              Host with a mobile Live Mode copilot, doorstep check-in, and morning-after gratitude.
            </p>
          </div>
        </div>
        ...
        {activeEventsCount > 0 && (
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8 pt-8 border-t border-slate-800/80">
            ...
            <div className="space-y-1">
              <p className="text-xs text-slate-400 font-medium">Friends on Guest Lists</p>
              <p className="text-2xl font-bold text-indigo-400">{totalGuests}</p>
            </div>
            <div className="space-y-1">
              <p className="text-xs text-slate-400 font-medium">Confirmed Friends</p>
              <p className="text-2xl font-bold text-emerald-400">{confirmedRSVPs}</p>
            </div>
            <div className="space-y-1">
              <p className="text-xs text-slate-400 font-medium">Attendance Momentum</p>
